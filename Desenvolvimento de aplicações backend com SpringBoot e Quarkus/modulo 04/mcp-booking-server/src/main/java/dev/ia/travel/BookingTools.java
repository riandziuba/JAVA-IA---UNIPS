...
public class BookingTools {
    ...
    @Tool(description = "Obtém os detalhes completos de uma reserva com base em seu número de identificação (bookingId).")
...
""")
    ...
    @Tool(description = "Lista os pacotes de viagem disponíveis para uma determinada categoria (ex: ADVENTURE, TREASURES).")
